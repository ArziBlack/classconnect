...
import { getGeneralAssessment } from "../../../../services/student/studentThunks";
...
const AssessmentList = () => {
  const { generalAssessment, isLoading } = useAppSelector((state) => state.student);
  const { data } = generalAssessment;
