...
import { studentResetVerify } from "../services/auth/authSlice";
...
const StudentPasswordV = () => {
  ...
  useEffect(() => {
    if (!hasRequested.current) {
      dispatch(studentResetVerify({ resetToken, email }));
...
export default StudentPasswordV;
