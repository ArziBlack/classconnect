...
const tutorSlice = createSlice({
  ...
  reducers: {
    resetTutor: (state) => {
      ...
      state.classReportResponse = null;
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        getMyStudents.fulfilled,
        (state, action: PayloadAction<IMyStudentsResponse>) => {
          state.isLoading = false;
      ...
      .addCase(
        createGeneralAssessments.fulfilled,
      ...
      .addCase(
        createPersonnalAssessment.fulfilled,
        (state, action: PayloadAction<IAssessmentResponse>) => {
          state.isLoading = false;
          state.isSuccess = true;
      ...
      .addCase(
        createPersonnalAssessment.rejected,
      ...
      .addCase(sendClassReport.pending, (state) => {
        state.isLoading = true;
        state.error = "";
        state.isSuccess = false;
      })
      .addCase(sendClassReport.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isSuccess = true;
        state.reportResponse = action.payload;
      })
      .addCase(sendClassReport.rejected, (state, action) => {
        state.isLoading = false;
        state.isError = true;
        state.error = action.payload || "Something went wrong";
      })
      ...
      .addCase(
        createStudentReport.fulfilled,
        (state, action: PayloadAction<IReportResponse>) => {
          state.isLoading = false;
          state.isSuccess = true;
          state.classReportResponse = action.payload;
        }
      )
      .addCase(
        createStudentReport.rejected,
        (state, action: PayloadAction<string>) => {
          state.isLoading = false;
          state.isError = true;
          state.error = action.payload || "Something went wrong";
      ...
      .addCase(
        sendClassNotice.fulfilled,
        (state, action: PayloadAction<INoticeResponse>) => {
          state.isLoading = false;
          state.isSuccess = true;
      ...
      .addCase(
        ...
        (state, action: PayloadAction<ICurriculumRes>) => {
          state.isLoading = false;
          state.isSuccess = true;
          state.curriculumResponse = action.payload;
        }
      ...
      .addCase(
        getNotificationsTutor.fulfilled,
      ...
      .addCase(
        getNotificationsTutor.rejected,
        (state, action: PayloadAction<string>) => {
          state.isLoading = false;
          state.isError = true;
          state.error = action.payload || "Something went wrong";
